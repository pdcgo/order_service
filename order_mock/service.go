...
func (o *orderServiceMock) OrderChangeStatus(context.Context, *connect.Request[order_iface.OrderChangeStatusRequest]) (*connect.Response[order_iface.OrderChangeStatusResponse], error) {
	panic("unimplemented")
}
